    ...
    <div class="h-svh w-full overflow-x-hidden bg-costm">
        <div class="navbar bg-transparent">
            <div class="navbar-start">
                ...
                <button class="btn btn-ghost lg:text-xl hidden lg:flex p-1">Carlos Hilado Memorial State University</button>
            </div>
            <div class="navbar-end">
                <button class="btn btn-ghost text-xl font-popin font-bold">
                    E-waste
        ...
        <div class="h-[90%] w-full lg:flex lg:flex-row flex-col">
            ...
            <div class="h-full lg:w-[50%] w-full flex flex-col">
                <h1 class="text-[53px] font-bold font-popin mt-[27%] text-wrap">E-Waste Management</h1>
                <h2 class="font-popin font-medium text-[30px]">Welcome to Admin Control</h2>
